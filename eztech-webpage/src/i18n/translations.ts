export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: 'Empowering digital transformation with AI, cloud solutions, and machine learning',
    ...
    services:{
      ...
      items:{
        ...
        cloud_migration:{
          ...
          subtitle:'We streamline cloud migration strategies to ensure secure, scalable, and efficient transitions, helping businesses embrace the power of the cloud with ease.',
        },
        ml_ai:{
        ...
        dashboarding:{
          title:'Dashboarding',
          subtitle:'We create intuitive, interactive dashboards that visualize critical business metrics, providing businesses with a clear and concise view of their performance.',
        },
        consulting:{
          title:'Consulting',
    ...
    products: {
      title: 'Our Products',
      subtitle: 'Innovative solutions designed for modern businesses',
      learnMore: 'Learn More',
      learnNote:'Coming Soon',
      items: {
        EZChat: {
          title: 'EZ Chat',
      ...
      commingSoon:{
        title:'Coming Soon!',
        subtitle:"We're working hard to bring something amazing to you.",
        subtitle2:'Stay tuned! connect with us for updates.',
        days:'days',
        hours:'hours',
        minutes:'minutes',
        second:'second'
    ...
    footer:{
      title:'EZ Tech',
      subtitle:'Innovating for a better future.',
  ...
  ru: {
    ...
    services: {
      title: 'Наши Услуги',
      subtitle: 'Комплексные технологические решения для трансформации вашего бизнеса',
      items: {
        digital_transformation: {
        ...
        cloud_migration: {
          ...
          subtitle: 'Мы упрощаем стратегии миграции в облако, обеспечивая безопасный, масштабируемый и эффективный переход, помогая бизнесу легко освоить возможности облачных технологий.',
        },
        ml_ai: {
        ...
        dashboarding: {
          ...
          subtitle: 'Мы создаем интуитивно понятные, интерактивные дашборды, которые визуализируют ключевые бизнес-метрики, предоставляя компаниям ясное и краткое представление об их эффективности.',
        },
        consulting: {
          title: 'Консалтинг',
    ...
    products: {
      ...
      items: {
        ...
        'EZDash': {
          title: 'EZ Dash',
          description: 'Продвинутая платформа для дашбордов и аналитики, которая превращает ваши данные в полезные инсайты с визуализацией в реальном времени.',
          features: ['Аналитика в Реальном Времени', 'Настраиваемые Отчеты', 'Интеграция Данных']
        },
        'EZNote': {
          title: 'EZ Note',
          description: 'Оптимизируйте совместную работу с помощью нашей интуитивной платформы для заметок и обмена информацией для внутренних и внешних команд.',
          features: ['Совместная Работа в Реальном Времени', 'Контроль Версий', 'Умная Организация']
        }
      },
      commingSoon:{
        title:'Скоро будет доступно!',
        subtitle:'Мы усердно работаем, чтобы подготовить для вас что-то невероятное.',
        subtitle2:'Оставайтесь с нами! Свяжитесь с нами, чтобы получать обновления.'
      }
      
    },
    contact: {
      title: 'Свяжитесь с Нами',
      subtitle: 'Есть вопросы или хотите узнать больше? Мы будем рады вам помочь.',
      form: {
        name: 'Полное Имя',
    ...
    footer: {
      title: 'EZ Tech',
      subtitle: 'Инновации ради лучшего будущего.',
      company: ["О нас", "Свяжитесь с нами"],
